...
const stuNames = studentNames.findIndex(Name => Name.includes('a')); // Name is arrow function (callback function) as parameter as a callback function
...
const sameNumber = randomNumbers.findIndex(number => number === 444); // number is arrow function (callback function) as parameter as a callback function
